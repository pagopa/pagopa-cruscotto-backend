 ...
 */
@Entity
@Table(name = "KPI_B5_ANALYTIC_DATA")
@Getter
@Setter
@DynamicUpdate
@DynamicInsert
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class KpiB5AnalyticData implements Serializable {

    private static final long serialVersionUID = -6090145346504076144L;

    @Id
    @Column(name = "CO_ID")
    @SequenceGenerator(name = "SQCRUSC8_KPIB5ANALDATA", sequenceName = "SQCRUSC8_KPIB5ANALDATA", allocationSize = 1)
    @GeneratedValue(generator = "SQCRUSC8_KPIB5ANALDATA", strategy = GenerationType.SEQUENCE)
    private Long id;
    ...
    @NotNull
    @ManyToOne(fetch = FetchType.LAZY)
    @JoinColumn(name = "CO_KPI_B5_DETAIL_RESULT_ID", nullable = false)
    private KpiB5DetailResult kpiB5DetailResult;
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof KpiB5AnalyticData that)) return false;
