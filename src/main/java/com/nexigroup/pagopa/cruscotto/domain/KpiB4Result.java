 ...
 * A KpiB4Result.
 * 
 * Represents the main result table for KPI B.4 "Zero Incident" calculation.
 * This entity stores summary results at the instance level showing overall compliance.
 */

@Entity
@Table(name = "KPI_B4_RESULT")
@Getter
@Setter
@DynamicUpdate
@DynamicInsert
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class KpiB4Result implements Serializable {

    private static final long serialVersionUID = 1L;

    @Id
    @Column(name = "CO_ID")
    @SequenceGenerator(name = "SQCRUSC8_KPIB4RESU", sequenceName = "SQCRUSC8_KPIB4RESU", allocationSize = 1)
    @GeneratedValue(generator = "SQCRUSC8_KPIB4RESU", strategy = GenerationType.SEQUENCE)
    private Long id;
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof KpiB4Result that)) return false;
