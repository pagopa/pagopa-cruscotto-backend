 ...
 * A KpiB3DetailResult.
 * 
 * Represents detailed results for KPI B.3 "Zero Incident" calculation at station level.
...
public class KpiB3DetailResult implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof KpiB3DetailResult)) {
            return false;
        }
        return id != null && id.equals(((KpiB3DetailResult) o).id);
    }
