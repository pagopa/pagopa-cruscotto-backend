...
public class KpiB4PagopaDataResource {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(KpiB4PagopaDataResource.class);

    private final PagopaApiLogDrilldownService pagopaApiLogDrilldownService;

    public KpiB4PagopaDataResource(PagopaApiLogDrilldownService pagopaApiLogDrilldownService) {
