...
public class AnagModuleResource {
    ...
    @PreAuthorize("hasAuthority(\"" + AuthoritiesConstants.MODULE_DETAIL + "\")")
     ...
     */
    @PostMapping("/modules")
    @PreAuthorize("hasAuthority(\"" + AuthoritiesConstants.MODULE_CREATION + "\")")
     ...
     **/
    @PutMapping("/modules")
    @PreAuthorize("hasAuthority(\"" + AuthoritiesConstants.MODULE_MODIFICATION + "\")")
    ...
    @PreAuthorize("hasAuthority(\"" + AuthoritiesConstants.MODULE_DELETION + "\")")
