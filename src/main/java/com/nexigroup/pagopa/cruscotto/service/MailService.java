...
public class MailService {
    ...
    @Value("${application.aws.ses.user}")
    private String from;
    ...
    @Async
    public void sendEmailFromTemplate(AuthUser user, String templateName, String titleKey) {
        sendEmailFromTemplateSync(user, templateName, titleKey);
    }

    private void sendEmailFromTemplateSync(AuthUser user, String templateName, String titleKey) {
    ...
    @Async
    public void sendPasswordResetMail(AuthUser user) {
