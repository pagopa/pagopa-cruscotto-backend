...
@Getter
@Setter
@ValidRangeDate.List({@ValidRangeDate(minDate = " predictedAnalysisStartDate", maxDate = " predictedAnalysisEndDate", pattern = "dd/MM/yyyy", field = "FIELD@predictedAnalysisStartDateEndDate"),
    @ValidRangeDate(minDate = "analysisStartDate", maxDate = "analysisEndDate", pattern = "dd/MM/yyyy", equalsIsValid = false, field = "FIELD@FIELD@analysisStartDateEndDate")})
public class InstanceFilter implements Serializable {
    ...
    public String toString() {
        return "InstanceFilter{" +
            "partnerId='" + partnerId + '\'' +
            ", status=" + status +
            ", predictedAnalysisStartDate='" + predictedAnalysisStartDate + '\'' +
            ", predictedAnalysisEndDate='" + predictedAnalysisEndDate + '\'' +
