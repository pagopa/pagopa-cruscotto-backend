...
public class KpiB2ResultDTO implements Serializable {
	...
	public String toString() {
		return "KpiB2ResultDTO [id=" + id + ", instanceId=" + instanceId + ", instanceModuleId=" + instanceModuleId
				...
				+ eligibilityThreshold + ", tollerance=" + tollerance + ", averageTimeLimit=" + averageTimeLimit
				+ ", evaluationType=" + evaluationType + ", outcome=" + outcome + "]";
	}
}
