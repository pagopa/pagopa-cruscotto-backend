...
public class KpiB9ResultServiceImpl implements KpiB9ResultService {
    ...
    public KpiB9ResultServiceImpl(InstanceRepository instanceRepository, InstanceModuleRepository instanceModuleRepository,
    ...
    public KpiB9ResultDTO save(KpiB9ResultDTO kpiB9ResultDTO) {
        Instance instance = instanceRepository.findById(kpiB9ResultDTO.getInstanceId())
        									  .orElseThrow(() -> new IllegalArgumentException("Instance not found"));

        InstanceModule instanceModule = instanceModuleRepository.findById(kpiB9ResultDTO.getInstanceModuleId())
    ...
    public void updateKpiB9ResultOutcome(long id, OutcomeStatus outcomeStatus) {
        ...
        jpql.set(QKpiB9Result.kpiB9Result.outcome, outcomeStatus)
        	.where(QKpiB9Result.kpiB9Result.id.eq(id))
        	.execute();
    }

    @Override
    public List<KpiB9ResultDTO> findByInstanceModuleId(long instanceModuleId) {
        return kpiB9ResultRepository.selectByInstanceModuleId(instanceModuleId)
        							.stream()
