...
public class KpiC2ResultServiceImpl implements KpiC2ResultService {
    ...
    private static KpiC2Result getKpiC2Result(
        ...
        kpiC2Result.setInstitutionTolerance(kpiC2ResultDTO.getInstitutionTolerance());
        kpiC2Result.setNotificationTolerance(kpiC2ResultDTO.getNotificationTolerance());
    ...
    private KpiC2ResultDTO convertToDTO(KpiC2Result kpiC2Result) {
        ...
        dto.setInstitutionTolerance(kpiC2Result.getInstitutionTolerance());
        dto.setNotificationTolerance(kpiC2Result.getNotificationTolerance());
