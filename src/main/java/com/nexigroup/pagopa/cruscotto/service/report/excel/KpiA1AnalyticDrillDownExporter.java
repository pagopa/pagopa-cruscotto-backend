...
@Component
@Order(1)
public class KpiA1AnalyticDrillDownExporter implements DrillDownExcelExporter<KpiA1AnalyticDrillDownDTO> {
    ...
    @Override
    public void writeSheet(Sheet sheet, List<KpiA1AnalyticDrillDownDTO> data) {
