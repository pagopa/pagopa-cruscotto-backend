...
public class KpiB5Job extends QuartzJobBean {
    ...
    protected void executeInternal(@NonNull JobExecutionContext context) {
        ...
        LOGGER.info("Start calculate kpi B.5, profile: {}",
        ...
        try {
            ...
            for (InstanceDTO instanceDTO : instanceDTOS) {
                try {
                    ...
                    LOGGER.error("Error processing instance {} for kpi B.5: {}", instanceDTO.getId(), e.getMessage(),
                            e);
                }
            }

        } catch (Exception exception) {
            LOGGER.error("Problem during calculate kpi B.5, {}",
            ...
            LOGGER.info("End calculations for kpi B.5, profile: {}",
    ...
    private void processInstanceModule(InstanceDTO instanceDTO, InstanceModuleDTO instanceModuleDTO,
        ...
        try {
            ...
            com.nexigroup.pagopa.cruscotto.domain.enumeration.OutcomeStatus outcome = kpiB5Service
                    .calculateKpiB5(instanceDTO.getId(), instanceModuleDTO.getId(), analysisDate);
            ...
            LOGGER.error("Error processing instance module {} for KPI B.5: {}", instanceModuleDTO.getId(),
                    e.getMessage(), e);
